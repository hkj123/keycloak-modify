...
public class OIDCWellKnownProvider implements WellKnownProvider {
	...
	public static final List<String> DEFAULT_SUBJECT_TYPES_TEST = list("again");
	...
	public static final List<String> DEFAULT_CLIENT_AUTH_SIGNING_ALG_VALUES_SUPPORTED = list( Algorithm.RS256.toString(), Algorithm.PS256.toString(), Algorithm.ES256.toString() );
	...
	public static final List<String> DEFAULT_CLAIMS_SUPPORTED= list("aud", "sub", "iss", "openbanking_intent_id", IDToken.AUTH_TIME, IDToken.NAME, IDToken.GIVEN_NAME, IDToken.FAMILY_NAME, IDToken.PREFERRED_USERNAME, IDToken.EMAIL);
